  ...
  return (
    <div className='mt-8 flex flex-col lg:flex-row gap-8'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <Link className='text-blue-800 lg:tetx-lg'>Web Design</Link>
            <span className='text-gray-500'>2 days ago</span>
        </div>
        {/* Title */}
        <Link to="/test" className='text-xl lg:text-3xl font-semibold lg:font-bold'>The best web design tools in 2021</Link>
        </div>
        {/* Other */}
        <div className="w-full lg:w-1/2 flex flex-col gap-4">
            {/* second */}
            <div className='lg:h-1/3 flex justify-between gap-4'>
                ...
                <div className='w-2/3'>
                    ...
                    {/* Title */}
                <Link to="/test" className='text-base sm:text-lg md:text-2xl lg:text-xl xl:text-2xl font-medium'>The best web design tools in 2021</Link>
                </div>
            </div>
            {/* third */}
            <div className='lg:h-1/3 flex justify-between gap-4'>
